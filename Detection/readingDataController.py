...
path = '/home/eduardo/Documentos/DVS/Eduardo work/Mestrado/Datasource/AEDAT_files/Mouse.aedat'
...
for f in totalImages:
    ...
    #watershedImage = segmentationUtils.watershed(f,'--avg --median --neuromorphic')
